---
description: Start a new work feature or Jira task
...
- `plan.md`: optional formal implementation plan for complex work

Search `Knowledge-Base/` and `memory/` for related context. Ask the user for requirements if not provided.
