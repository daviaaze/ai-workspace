---
name: daily
description: Generate or update Lux daily stand-up and end-of-day review notes from TODOs, Jira, PRs, lifecycle gates, blockers, deploys, and learnings. Use when the user asks for daily, standup, daily review, end-of-day summary, plan tomorrow, or what was done today.
---
