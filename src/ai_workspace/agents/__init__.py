...
def __getattr__(name: str):
    _imports = {
        ...
        "LoopParams": "ai_workspace.agents.types",
        "LoopEvent": "ai_workspace.agents.types",
        "LoopState": "ai_workspace.agents.types",
        "TerminalReason": "ai_workspace.agents.types",
        "LoopPattern": "ai_workspace.agents.patterns",
        "suggest_pattern": "ai_workspace.agents.patterns",
        "Capability": "ai_workspace.agents.capabilities",
        "get_capability": "ai_workspace.agents.capabilities",
        "suggest_capability": "ai_workspace.agents.capabilities",
        "BUILTIN_CAPABILITIES": "ai_workspace.agents.capabilities",
        "CAPABILITY_CHAT": "ai_workspace.agents.capabilities",
        "CAPABILITY_RESEARCH": "ai_workspace.agents.capabilities",
        "CAPABILITY_CODE": "ai_workspace.agents.capabilities",
        "CAPABILITY_SOLVE": "ai_workspace.agents.capabilities",
        "CAPABILITY_WRITE": "ai_workspace.agents.capabilities",
        ...
        "TieredContextLoader": "ai_workspace.agents.tiered_context",
        "TieredContextConfig": "ai_workspace.agents.tiered_context",
        "ContextTier": "ai_workspace.agents.tiered_context",
        "RetrievalStep": "ai_workspace.agents.tiered_context",
...
__all__ = [
    "agent_loop", "coding_agent_loop",
    "LoopParams", "LoopEvent", "LoopState", "LoopPattern", "TerminalReason",
    "suggest_pattern",
